...
public class AdapterForTestDB {
    ...
    private static final String DATABASE_GOOD_CREATE_STATEMENT = "CREATE TABLE good ("+
            "_id INTEGER not null PRIMARY KEY AUTOINCREMENT,  id_section int(3) not null default 0,"+
            " id_publish int(4) not null default 0,    id_author int(4) not null default 0,"+
            "title char(255) not null default '',    pages int(10) not null default 0,"+
            " year_publish  int(4) not null default 0,    price float(5,2) not null default 0,"+
        ...
        private static class DatabaseHelper extends SQLiteOpenHelper {
            ...
            public void onCreate(SQLiteDatabase db) {
                ...
                db.execSQL("INSERT INTO `section` VALUES (1,'root',1,12);");
                db.execSQL("INSERT INTO `section` VALUES(2,'книги','2','7')");
                db.execSQL("INSERT INTO `section` VALUES(3,'детективы','3','4')");
                db.execSQL("INSERT INTO `section` VALUES(4,'канцтовары','8','11')");
                db.execSQL("INSERT INTO `section` VALUES(5,'тетради','9','10')");
                db.execSQL("INSERT INTO `section` VALUES(6,'детская','5','6')");

                db.execSQL("INSERT INTO `author` VALUES(1,'Агата Кристи')");
                db.execSQL("INSERT INTO `author` VALUES(2,'Корней Чуковский')");
                db.execSQL("INSERT INTO `author` VALUES(3,'Агния Барто')");
                db.execSQL("INSERT INTO `author` VALUES(4,'Джеймс Чейз')");
